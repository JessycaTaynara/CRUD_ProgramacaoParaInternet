  ...
  try {
    ...
    for (let i = 0; i < listaGatos.length; i++) {
      if (listaGatos[i].nome == nomeGato) {
        ...
        const nome = (document.querySelector("input#nomee").value =
          listaGatos[i].nome);
        const raca = (document.querySelector("input#racaa").value =
          listaGatos[i].raca);
        const cor = (document.querySelector("input#corr").value =
          listaGatos[i].cor);
        const idade = (document.querySelector("input#idadee").value =
          listaGatos[i].idade);
        const sexo = (document.querySelector("input#sexoo").value =
          listaGatos[i].sexo);
        const descricao = (document.getElementById("descricaoo").value =
          listaGatos[i].descricao);
        break;
      }
    }
  } catch (error) {
